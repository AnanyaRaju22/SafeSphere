        ...
        fusedLocationProviderClient.getLastLocation ().addOnCompleteListener (new OnCompleteListener<Location> () {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    Message =Message + "I am at 37.4220541,-122.08532419999999, United States, Mountain View, 1600 Amphitheatre Pkwy, Mountain View CA 94043, USA";

                }
                String phoneNumber1 = Value1;
                String phoneNumber2 =Value2;
                String phoneNumber3 = Value3;
                Log.d ("Message sent as  ", Value1 + " " + Value2 + " " + Value3 + " " + Value + " ");
