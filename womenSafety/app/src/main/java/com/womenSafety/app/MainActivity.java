...
public class MainActivity extends AppCompatActivity {
    CardView siren, location, Settings, currentlocation, community, news, lawsCard, aboutUs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission (MainActivity.this,
            ...
            heading.setText("womenSafety needs access to");
            ...
            checkBoxtext.setText(Html.fromHtml("I accept the " +
                    "<a href=''>PRIVACY POLICY</a>"+" of the app"));
        ...
        lawsCard = findViewById(R.id.WomenSafetyLaws);
        ...
        lawsCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
