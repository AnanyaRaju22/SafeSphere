...
public class SmsActivity extends AppCompatActivity {
    ...
    TextInputEditText txt_pnumber1, txt_msg, txt_pnumber2, txt_pnumber3;
    Button Save;
...
//                v=(Vibrator)context.getSystemService(Context.VIBRATOR_SERVICE);
                ...
                txt_msg.setText (msg);
                if (!txt_pnumber1.getText ().toString ().equals ("") && !txt_pnumber2.getText ().toString ().equals ("") && !txt_pnumber3.getText ().toString ().equals ("") ) {
                    Toast.makeText (SmsActivity.this, "Saved...", Toast.LENGTH_SHORT).show ();

                } else if (!txt_pnumber1.getText ().toString ().equals ("") || !txt_pnumber2.getText ().toString ().equals ("") || !txt_pnumber3.getText ().toString ().equals ("")) {
        ...
        fusedLocationProviderClient.getLastLocation ().addOnCompleteListener (new OnCompleteListener<Location> () {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    String str="I am at 37.4220541,-122.08532419999999, United States, Mountain View, 1600 Amphitheatre Pkwy, Mountain View CA 94043, USA";
                    Message += str;
                }
